...
const createExecuteInterfaceRequest = (payload, source, globals) => {
  ...
  const request = {
    requestString: {
      ...
      cardsBdrLc1: (empAssistanceToggle && employeeAssistancePanel?.cardsBdrLc1?.$value) || '',
      tseLgCode: (empAssistanceToggle && employeeAssistancePanel?.tseLgCode?.$value) || '',
      ...
      leadClosures: '',
      leadGenerater: '',
      lc1: (empAssistanceToggle && employeeAssistancePanel?.lc1Code?._data?.$_value) || '',
      lgCode: (empAssistanceToggle && employeeAssistancePanel?.lgCode?._data?.$_value) || '',
