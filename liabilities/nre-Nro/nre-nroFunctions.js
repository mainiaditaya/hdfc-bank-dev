...
const crmLeadIdDetail = () => {
  ...
  const jsonObj = {
    requestString: {
      ...
      userAgent: window.navigator.userAgent,
      misCodeDetails: '',
      identifierValue: `${day}/${month}/${year}`, // doubt in format
      DoB: `${day}/${month}/${year}`, // multiple dob value
      ...
      isIndianTaxResident: '1',
      isTaxAddressSame: 'Yes',
      isMailIDAvailable: 'Yes',
      isPresentAddressSame: 'Yes',
      isCommunicationAddressSame: 'Yes',
      isPermanentAddressSame: 'Yes',
      isSameAddress: 'Yes',
      fatherNAme: response.customerFATCADtlsDTO[0].namCustFather,
      employeeCategory: '2',
      employeeCategory_label: 'Private Ltd',
      otherEmployeeCategory: '2',
      otherEmployeeCategory_label: 'Private Ltd',
      occupationType: '',
      ...
      marital_Status: '1', // master data
      spouseName: response.customerFATCADtlsDTO[0].namCustSpouse,
      declareNominee: 'Yes',
      otherTypeOfFirm: '2',
      otherTypeOfFirm_label: 'Private Ltd',
      otherSourceOfFunds: '',
      nomineeAddressLine2: '', // nominee address not mention
      nomineeLandmark: '',
      nomAdrCity: '',
      nomAdrCntry: '',
      nomAdrState: '',
      ...
      grossAnnualIncome_range: '10-15 lac',
      monthlyIncome: '100000',
      selfServiceAnnualIncome: '1200000',
      sourceOfFunds: response.customerAMLDetailsDTO[0].incomeSource || '',
      sourceOfFunds_label: response.customerAMLDetailsDTO[0].incomeSource || '', // master data
      ...
      residenceType_label: 'Owned', // master data
      ...
      lastName: response.customerLastName || 'test', // not null
      layout: '',
      ...
      mobileNo: '8499385539', // currentFormContext.mobileNumber,
      ...
      residentialStatus_label: 'Resident',
      salutationKey: '1', // master data
      ...
      transcriptLatLong: '',
      videoKYCFinalStatus: '',
      isAadharBasedAccountOpening: 'Yes',
      AMBStamping: 'Yes',
      companyCode: '6600A',
      occupationTypeOther: '',
      ...
      codCCBrn: '',
      codProd: '',
      codOccupation: '2', // master data
      codProfession: '',
      selfEmpFrom: '',
      incomeSource: '7',
      typEmployer: '2',
      typResidence: '2',
      typResidence_label: 'Owned',
      ...
      addrProof: 'A',
      addressType: '2', // master data
      branchCode: response.customerAccountDetailsDTO[accIndex].branchCode.toString(), // change to string
      branchId: '22216',
      custFatherName: response.customerFATCADtlsDTO[0].namCustFather,
      docNumber: response.customerFATCADtlsDTO[0].idDocNum, // test
      ADVRefrenceKey: '',
      RRN: '',
